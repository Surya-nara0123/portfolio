        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            >
              ...
              <span className="hidden sm:block text-xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
                Surya.dev
              </span>
            </div>

            {/* Desktop Navigation - simple hover state */}
            ...
            <button
              ...
              className="md:hidden relative w-10 h-10 rounded-xl bg-gray-900/80 border border-gray-700 flex items-center justify-center"
            >
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 bottom-0 w-80 bg-gray-950 border-l border-gray-800"
            >
