...
const StatItem = memo(({ label, value, color, inView, index }: {
    label: string;
    value: string;
    color: string;
    inView: boolean;
...
const Trait = memo(({ trait, index, inView }: {
    trait: string;
    index: number;
    inView: boolean;
}) => (
    <motion.span
        ...
        animate={inView ? { opacity: 1, scale: 1, y: 0 } : { opacity: 0, scale: 0, y: 20 }}
        transition={{ 
...
const ProfileSummary = () => {
    ...
    const stats = [
        { label: 'Projects Completed', value: '25+', color: 'from-blue-400 to-cyan-400' },
        { label: 'Technologies Mastered', value: '30+', color: 'from-purple-400 to-pink-400' },
        { label: 'Years Experience', value: '3+', color: 'from-green-400 to-emerald-400' },
        { label: 'Certifications', value: '8+', color: 'from-orange-400 to-red-400' },
    ];

    const traits = [
        'Problem Solving', 'Innovation', 'Collaboration', 'Continuous Learning',
        'User Experience', 'Clean Code', 'Scalability', 'Performance Optimization',
        'API Design', 'Database Architecture', 'DevOps', 'Agile Methodology'
    ];

    return (
        <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-950 via-gray-900 to-black relative overflow-hidden">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
                    ...
                    >
                        <div className="bg-gradient-to-r from-gray-900/50 to-black/50 p-8 rounded-3xl border border-gray-700/50 backdrop-blur-lg">
                            <h3 className="text-3xl font-semibold mb-6 text-white">Professional Summary</h3>
                            <p className="text-gray-300 leading-relaxed mb-6 text-lg">
                                I am a passionate Full Stack Developer with expertise in modern web technologies 
                                and a strong foundation in software engineering principles. I thrive on turning 
                            ...
                            <p className="text-gray-300 leading-relaxed text-lg">
                                ...
                                real-world problems through innovative solutions that make a meaningful impact.
                            </p>
                        </div>

                        <div className="bg-gradient-to-r from-gray-900/50 to-black/50 p-8 rounded-3xl border border-gray-700/50 backdrop-blur-lg">
                            <h4 className="text-2xl font-semibold mb-6 text-white">Current Focus</h4>
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        ...
                                        <span className="text-gray-300 text-lg group-hover:text-white transition-colors duration-300">{item}</span>
                                    </motion.div>
                                ))}
                            </div>
                        </div>
